...
export function UpgradeDialog({
  ...
  const availableTiers = [PlanTier.STARTER, PlanTier.PRO, PlanTier.TEAM].filter(
    (tier) => {
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              • All plans include MCP integration and priority GitHub Issues
              support
            </p>
            <p>• Billing is monthly - cancel anytime</p>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleUpgrade} disabled={createCheckout.isPending}>
            ...
            Upgrade to{" "}
            {PLAN_DETAILS[selectedTier as keyof typeof PLAN_DETAILS]?.name ||
              "Selected Plan"}
          </Button>
        </DialogFooter>
      </DialogContent>
