...
ALTER TYPE "public"."SourceType" ADD VALUE 'CONFLUENCE';--> statement-breakpoint
ALTER TYPE "public"."SourceType" ADD VALUE 'NOTION';--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "Workspace" ADD COLUMN "metadata" jsonb;--> statement-breakpoint
...
CREATE UNIQUE INDEX "collection_sources_collectionId_sourceId_key" ON "collection_sources" USING btree ("collectionId","sourceId");--> statement-breakpoint
